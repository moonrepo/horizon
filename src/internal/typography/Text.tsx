...
export type InferTextProps<T extends TextElement> = T extends keyof JSX.IntrinsicElements
...
export function Text<T extends TextElement>(props: InferTextProps<T> & TextProps<T>) {
	...
	return (
		<Dynamic<TextElement> component={elementType()} {...(other as unknown as TextProps<T>)}>
